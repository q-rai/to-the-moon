...
\begin{description}[leftmargin=6em,noitemsep,style=nextline]
    \item[Leads:]  Brad ``Bradass'' Tomlinson, Ashley "Bones" Abbott, Bluntqueen, Chance ``Gryffn'' Loman, Julie Reach, Eisa Nuri
   \item[Contact:] \url{bod@tothemoonburn.com}
\end{description}
}
...
\begin{description}[leftmargin=6em,noitemsep,style=nextline]
   \item[Leads:] Topshelof, Atl, Brian Weiner, Johnnie Popsicles, Evelyn Smiles, Misha ``Shining Soul'' Eli
   \item[Contact:] \url{elt@tothemoonburn.com}
\end{description}
}

\subsection*{Art Department}
The Art Department stays connected with artists from initial inquiry about Art Registration and / or Art Grant Application, communicates with safety teams and BOD about amounts granted, fire and other safety concerns regarding interactive art and about feasibility and scope of art projects. Art Team also works closely with placement to ensure the best spot for any art projects. 

\begin{description}[leftmargin=6em,noitemsep,style=nextline]
   \item[Lead:] Christal ``Hatter'' Yo-Delux
   \item[Co-leads:] Ashley Humphries, Lindsey ``Naughty Frog'' Wright 
...
\begin{description}[leftmargin=6em,noitemsep,style=nextline]
   \item[Lead:] Alicia ``Alley Hoops'' Westbrook
   \item[Co-leads:] David Vance
...
Media is in charge of newsletter, insta, FB, and general   And general informaative things.
...
\begin{description}[leftmargin=6em,noitemsep,style=nextline]
   ...
   \item[Co-leads:] Miaih Duck % $\emptyset$
