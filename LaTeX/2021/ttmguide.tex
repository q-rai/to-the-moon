...
\documentclass[fontsize=8pt,twocolumn,titlepage,numbers=noenddot,DIV=16]{scrreprt}
...
\newcommand{\ttmfont}[1]{\fontsize{1.4cm}{1cm}\selectfont{\textbf{\textcolor{white}{\sffamily#1}}}}
\newcommand{\guidetypefont}[1]{\fontsize{0.8cm}{1.4cm}\selectfont{\textbf{\textcolor{white}{\sffamily#1}}}}
\newcommand{\guideversionfont}[1]{\fontsize{.65cm}{1.3cm}\selectfont{\textcolor{white}{\sffamily#1}}}
\newcommand{\locationfont}[1]{\fontsize{0.4cm}{.3cm}\selectfont{\textbf{\textcolor{white}{\sffamily\uppercase{#1}}}}}
...
\begin{textblock}{200}(30,75)
\ttmfont{To The Moon}
\end{textblock}

\begin{textblock}{200}(30,100)
\guidetypefont{Pocket Guide}
\end{textblock}

\begin{textblock}{200}(30,110)
\guideversionfont{Draft --- Event Postponed}
% \guideversionfont{October 7--11, 2021}
\end{textblock}

    \begin{textblock}{200}(30,160)
\locationfont{Catoosa Event Center\\[8pt] Allardt, Tennessee}
\end{textblock}
